<?php
/**
 * Template Name: C60 Pet Benefits
...
<main class="healthy-page c60-pet-benefits">
        ...
        <section class="healthy-hero">
                <div class="healthy-hero__inner inner-section-1220">
                            <h1>Why should you choose C60 Purple Power<br />
                            for Pets? That’s an easy one…</h1>

                        <div class="healthy-hero__img-text">
                            <div class="healthy-hero__text">
                                <p>
                                Our pets mean the world to us. And, well beyond companionship, research shows that having a pet as part of your family can boost your immune system, lessen anxiety, and lower your risk of cardiovascular disease
                                </p>

                                <p>
                                They can even help relieve pain. In a study of people who had undergone total joint replacement surgery, the ones who spent time with therapy dogs needed 28 percent less pain medication. </p>
        ...
        <section class="c60-pets2">
                <div class="healthy-hero__inner inner-section-1220">
                            ...
                            <div class="healthy-hero__img-text">
                                <div class="healthy-hero__text">
                                    <p>
                                    In 2012, scientists found that C60 nearly doubled the lifespan of test animals and prevented cognitive decline and other diseases associated with aging. <span class="text-indent">1</span>
                                    </p>

                                    <p>
                                    And, in another study, test animals were given C60 for two weeks before being exposed to what should have been a lethal dose of radiation.</p>
                ...
                <div class="healthy-hero__inner inner-section-1220">
                            ...
                            <div class="healthy-hero__img-text">
                                ...
                                <div class="healthy-hero__text">
                                    ...
                                    <p>
                                    Short for Carbon 60, C60 is a naturally occurring molecule made up of 60 carbon atoms forming a shape that resembles a hollow soccer ball. C60 is relatively new discovery, but it is believed to be one of the most powerful antioxidants ever discovered. The scientists who discovered C60 won a Nobel prize for their work in 1996. It is characterized as a “free radical sponge” with antioxidant effects several hundred-fold higher than conventional antioxidants. 
                                    </p>
                                    ...
                                    <p>
                                    C60 Purple Power is intended to be administered orally. You can easily add it to their food. We recommend avocado, extra virgin olive oil, or MCT coconut for cats, and extra virgin olive or avocado for dogs. Like humans, pets may have a preferred flavor. Do not give avocado oil to birds. Do not give to your pet if your pet is on blood thinners.</p>
                                    <br />
                                    ...
                                    <p>Our C60 for pets should be stored in a dark, dry place away from both heat and light. Do not refrigerate C60. </p>
                                    <br />
                                    ...
                                    *Please consult your veterinarian or medical professional. These statements and products have not been evaluated by the Food & Drug Administration. This product is not intended to diagnose, treat, cure, or prevent any disease.</span>
                                    </p>
